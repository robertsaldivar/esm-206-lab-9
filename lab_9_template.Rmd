...
#Note: This is Bad (because PricePerSqFt is calculated from dependent variable --- biased of overfitting the model)
...
homes_lm3 <- lm(Price~ City + City + SqFt + Status, data = homes_sub)
summary(homes_lm3)
